        ...
        content = { paddingValues ->
            Column (
                ...
                Column (
                    ...
                    Text(
                        text = "Você está prestes a excluir sua conta permanentemente. Isso significa que todos os seus dados, incluindo históricos de agendamentos, preferências e informações gerais, serão apagados e não poderão ser recuperados.",
                        modifier = Modifier.padding(horizontal = 16.dp),
